...
def choices():
    ...
    tenant1 = 'https://paulohennighotmail.us3.portal.cloudappsecurity.com/api/v1/alerts/'
    tenant1_token = {
        'Authorization': 'Token X05aQ0BHSkFBRkhHQFtCTkZDAVpcHAFfQF1bTkMBTENAWktOX19cSkxaXUZbVgFMQEJTGBcXShlNFxwcHEkfS0xJHBsYSx5JGBgbHhocSUsbSRdLGxdNHRtKHEoZS0sfHx0ZTUtJHU4aH0xNGBgZHR9MGg=='}
